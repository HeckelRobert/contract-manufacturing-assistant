...
public partial class ProjectMatchItemViewModel : ObservableObject
{
    public ProjectMatchItemViewModel(
        ...
        string projectProfileText,
        string matchExplanationsText,
        string projectProfileLabel,
        string matchExplanationsLabel,
        ...
        string selectedForProposalBadge)
    {
        ...
        ProjectProfileText = projectProfileText;
        MatchExplanationsText = matchExplanationsText;
        ProjectProfileLabel = projectProfileLabel;
        MatchExplanationsLabel = matchExplanationsLabel;
    ...
    public string ProjectProfileText { get; }

    public string MatchExplanationsText { get; }

    public string ProjectProfileLabel { get; }

    public string MatchExplanationsLabel { get; }
